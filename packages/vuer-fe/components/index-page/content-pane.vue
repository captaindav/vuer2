<template>
  <v-row class="fill-height">
    <v-col style="height: 100%" cols="12" class="ma-2">
      ...
      <!-- <DruxtEntity type="outline_entry--_DIR" uuid="ae46f356-888e-4666-b712-02ddffe1a4d1" /> -->
    </v-col>
  </v-row>
</template>
...
export default {
  ...
  setup (props, context) {
    ...
    // outline_entry--_DIR
      ...
      const druxt = new DruxtClient('http://drupal-9.ddev.site')
